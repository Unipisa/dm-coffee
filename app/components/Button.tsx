...
export default function Button({ children, onClick, variant, disabled }:{
    ...
    const className = {
        default: 'text-white bg-myBlue hover:bg-myBlue-dark focus:ring-4 focus:outline-none focus:ring-myBlue-light font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center',
